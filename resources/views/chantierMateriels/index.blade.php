...
<div class="container" >
		<div class="card">
			<div class="card-body">
				...
				<div >
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Chercher chantier-mtériel</h5>

                        <form class="form-material" type="get" action="{{ route('chantierMateriels.getChantierInfo') }}" >
...
<div class="form-material">
        ...
        <a class="btn btn-primary text-right" href="{{ route('chantierMateriels.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau chantier-matériels</a> 
        ...
        <h5 style="margin-left: 25px; margin-bottom: 15px;" >Gestion des matériels des chantiers</h5>
            ...
            <div class="col-6">
                <div class="form-group form-primary form-static-label">
                    <select class="form-control" id="chantiers" type="dropdown-toggle" class="form-control" name="chantiers" onchange="top.location.href = this.options[this.selectedIndex].value" >
                        ...
                        <option class="chantiers" value="{{  route('chantierMateriels.showMateriels',$chantier->id) }}">{{$chantier->intitule_chantier}}</option>
                        @endforeach
                    </select>
                </div>                
