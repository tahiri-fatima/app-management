    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des matériels des chantiers</h5>

                        <form class="form-material" type="get" action="{{ route('chantierMateriels.gotoIndex') }}" >
                                ...
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="chantiers" type="dropdown-toggle" class="form-control" name="chantier_id" >
                                        ...
                                        @foreach($chantiers as $chantier)
                                            <option class="chantiers" value="{{$chantier->id }}">{{$chantier->code_chantier}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer les matériels du chantier ?</p>
                                </strong>
                            </div>
