...
<div class="container" >
		<div class="card">
			<div class="card-body">
				...
				<div >
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Chercher Chantier-Qualification</h5>

                        <form class="form-material" type="get" action="{{ route('chantierQualifications.search') }}" >
...
<div class="form-material">
        ...
        <a class="btn btn-primary text-right" href="{{ route('chantierQualifications.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau chantier-opérations</a> 
        ...
        <h5 style="margin-left: 30px; margin-bottom: 15px;" >Gestion des qualifications des chantiers</h5>
            ...
            <div class="col-6">
                <div class="form-group form-primary form-static-label">
                    <select class="form-control" id="chantiers" type="dropdown-toggle" class="form-control" name="chantiers" onchange="top.location.href = this.options[this.selectedIndex].value" >
                        ...
                        <option class="chantiers" value="{{  route('chantierQualifications.showQualifications',$chantier->id) }}">{{$chantier->intitule_chantier}}</option>
                        @endforeach
                    </select>
                </div>                
