...
<!-- Alert si le code est dupliqué !-->
    @if(!empty(Session::get('error_code')) && Session::get('error_code') == 1)
        <div class="alert alert-danger message">
            <strong>Whoops!</strong> Il y a dejà un enregistement avec ces codes de qualification et de chantier.<br><br>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-outline-secondary" href="{{ route('chantierQualifications.index') }}"> Non</a>
...
<div style="width:100%" >
    <div class="card" >  
        <div class="card-header">
            <h5><i class="fa fa-fw fa-plus-circle"></i>  Ajouter les qualifications de chantier</h5>
        </div>
        <div class="card-block">
             <div class="table-responsive">
                <form id="form" class="form-material" action="{{ route('chantierQualifications.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return verifierChampsQual()" >
                @csrf
            ...
            <h5 style="margin-bottom:15px">Liste des qualifications :</h5>
                    <table class="mytab  m-b-0 text-center" >
                        <thead style="font-weight:bold">
                            ...
                            <td>Durée Estimée</td>
                            <td>Effictif Estimée</td>    
                            <td>Salaire Estimée</td>
                        </thead>
                        <tbody >
                            @foreach($qualifications as $qualification)
                                <tr style="display:none; " id="{{ $qualification->id }}" class="data">
                                    ...
                                    onchange="recupValeurQual(this.value, this.id);" data-required="1" > </td>
                            ...
                            @endforeach
                                ...
                                <tr>
                                    <td colspan="5" style="text-align:center;font-weight:bold" >Total des Salaires</td>
