...
<div class="container " style="margin-left: 15%;" > 
        <a class="btn btn-outline-primary text-right" href="{{ route('chantierNatureFrais.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau chantier-opérations</a> 
        @can('edit')
        <a class="btn btn-outline-primary"  href="{{  route('chantierNatureFrais.editNatureFrais',$chantier->id) }}" ><i class="fa fa-fw fa-edit"></i> Modifier</a>
        @endcan
        @can('delete')
        <button type="submit" class="btn btn-outline-primary" onclick="$('#modal').modal('show');" ><i class="fa fa-fw fa-trash"></i> Supprimer</button>
        @endcan
       <a class="btn btn-outline-primary" href="{{ route('chantierNatureFrais.index') }}" ><i class="fa fa-fw fa-arrow-circle-left"></i> Retour</a> 
...
<div   class="modal" tabindex="-1" role="dialog" id="modal" >
  ...
  <form class="modal-content"action="{{ route('chantierNatureFrais.destroyChantierNatureFrais',$chantier->id) }}" method="POST">
