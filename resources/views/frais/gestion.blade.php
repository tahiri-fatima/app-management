		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des frais</h5>
                        ...
                        <form class="form-material" type="get" action="{{ route('frais.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="frais" type="dropdown-toggle" class="form-control" name="frais_id" >
                                        <option value="choisir" selected disabled>Choisir Frais</option>
                                        @foreach($frais as $frai)
                                            <option class="frais" value="{{$frai->id }}">{{$frai->code_frais}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                    <a class="btn btn-outline-primary" href="{{ route('frais.index') }}" ><i class="fa fa-fw fa-arrow-circle-left"></i> Retour</a> 
                                    </div>
                                </div>
                            </div>
                        </form>
