    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des qualifications</h5>

                        <form class="form-material" type="get" action="{{ route('qualifications.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="qualifications" type="dropdown-toggle" class="form-control" name="qualification_id" >
                                        <option value="choisir" selected disabled>Choisir Qualification</option>
                                        @foreach($qualifications as $qualification)
                                            <option class="qualifications" value="{{$qualification->id }}">{{$qualification->designation_qual}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cette qualification ?</p>
                                </strong>
                            </div>
