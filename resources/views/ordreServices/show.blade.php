...
<div class="col-xl-6 col-md-12 ">
    <div class="card table-card">
         ...
         <div class="card-header">
            <h5>Détails d'ordre de service</h5>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <div class="d-inline-block align-middle">
                                        <div class="d-inline-block">
                                            <h6> {{ $ordreService->code_ordre_serv }}</h6>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td >
                                    <div class="d-inline-block align-middle">
                                        <div class="d-inline-block">
                                            <h6>  {{ $ordreService->type_ordre_serv }}</h6>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >
                                    <div class="d-inline-block align-middle">
                                        <div class="d-inline-block">
                                            <h6>{{ $ordreService->date_ordre_serv }}</h6>
                                        </div>
                                    </div>
                                </td>
                            </tr>
