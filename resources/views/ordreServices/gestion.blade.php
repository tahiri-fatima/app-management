    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des opérationx</h5>

                        <form class="form-material" type="get" action="{{ route('ordreServices.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="ordreServices" type="dropdown-toggle" class="form-control" name="ordreService_id" >
                                        <option value="choisir" selected disabled>Choisir Ordre de Service</option>
                                        @foreach($ordreServices as $ordreService)
                                            <option class="ordreServices" value="{{$ordreService->id }}">{{$ordreService->code_ordre_serv}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cet ordre de service ?</p>
                                </strong>
                            </div>
