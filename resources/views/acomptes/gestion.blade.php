    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des acomptes</h5>

                        <form class="form-material" type="get" action="{{ route('acomptes.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="acomptes" type="dropdown-toggle" class="form-control" name="acompte_id" >
                                        <option value="choisir" selected disabled>Choisir Acompte</option>
                                        @foreach($acomptes as $acompte)
                                            <option class="acomptes" value="{{$acompte->id }}">{{$acompte->code_acompte}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cet acompte ?</p>
                                </strong>
                            </div>
