		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des decomptes</h5>
                        ...
                        <form class="form-material" type="get" action="{{ route('decomptes.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="decomptes" type="dropdown-toggle" class="form-control" name="decompte_id" >
                                        <option value="choisir" selected disabled>Choisir Décompte</option>
                                        @foreach($decomptes as $decompte)
                                            <option class="decomptes" value="{{$decompte->id }}">{{$decompte->num_decompte}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer ce décompte ?</p>
                                </strong>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                    <a class="btn btn-outline-primary" href="{{ route('decomptes.index') }}" ><i class="fa fa-fw fa-arrow-circle-left"></i> Retour</a> 
                                    </div>
                                </div>
                            </div>
                        </form>
