...
<div class="container " style="margin-left: 20%;" > 
        <a class="btn btn-outline-primary text-right" href="{{ route('decomptes.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau décompte</a> 
        @can('edit')
        <a class="btn btn-outline-primary"  href="{{ route('decomptes.edit',$decompte->id) }}" ><i class="fa fa-fw fa-edit"></i> Modifier</a>
        @endcan
...
<div   class="modal" tabindex="-1" role="dialog" id="modal" >
  ...
  <form class="modal-content"action="{{ route('decomptes.destroy',$decompte->id) }}" method="POST">
      ...
      <div class="modal-body ">
          <strong >
            ...
            <p>Voulez vous supprimer le décompte dont le code {{ $decompte->num_decompte }} ?</p>
        </strong>
      </div>
