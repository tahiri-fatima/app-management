...
<div class="container" >
		<div class="card">
			<div class="card-body">
				...
				<div >
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Chercher chantier-opération</h5>

                        <form class="form-material" type="get" action="{{ route('chantierOperations.searchOperationsByChantier') }}" >
...
<div class="form-material">
        ...
        <a class="btn btn-primary text-right" href="{{ route('chantierOperations.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau chantier-opérations</a> 
        ...
        <h5 style="margin-left: 30px; margin-bottom: 15px;" >Gestion des opérations des chantiers</h5>
            ...
            <div class="col-6">
                <div class="form-group form-primary form-static-label">
                    <select class="form-control" id="chantiers" type="dropdown-toggle" class="form-control" name="chantiers" onchange="top.location.href = this.options[this.selectedIndex].value" >
                        ...
                        <option class="chantiers" value="{{  route('chantierOperations.showOperations',$chantier->id) }}">{{$chantier->intitule_chantier}}</option>
                        @endforeach
                    </select>
                </div>                
