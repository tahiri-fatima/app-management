...
<div class="container " style="margin-left: 250%;" > 
        <a class="btn btn-outline-primary text-right" href="{{ route('soutraitances.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau sous traitance</a> 
        @can('edit')
        <a class="btn btn-outline-primary"  href="{{ route('soutraitances.edit',$soutraitance->id) }}" ><i class="fa fa-fw fa-edit"></i> Modifier</a>
        @endcan
        @can('delete')
...
<div   class="modal" tabindex="-1" role="dialog" id="modal" >
  ...
  <form class="modal-content"action="{{ route('soutraitances.destroy',$soutraitance->id) }}" method="POST">
      ...
      <div class="modal-body ">
          <strong >
            ...
            <p>Voulez vous supprimer le sous traitance dont le code {{ $soutraitance->code_soutraitance }} ?</p>
        </strong>
      </div>
