    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des sous traitances</h5>

                        <form class="form-material" type="get" action="{{ route('soutraitances.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="soutraitances" type="dropdown-toggle" class="form-control" name="soutraitance_id" >
                                        <option value="choisir" selected disabled>Choisir Sous traitance</option>
                                        @foreach($soutraitances as $soutraitance)
                                            <option class="soutraitances" value="{{$soutraitance->id }}">{{$soutraitance->intitule_soutraitance}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cette soutraitance ?</p>
                                </strong>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                    <a class="btn btn-outline-primary" href="{{ route('soutraitances.index') }}" ><i class="fa fa-fw fa-arrow-circle-left"></i> Retour</a> 
                                    </div>
                                </div>
                            </div>
                        </form>
