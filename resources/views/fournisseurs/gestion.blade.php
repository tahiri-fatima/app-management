		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des fournisseurs</h5>
                        ...
                        <form class="form-material" type="get" action="{{ route('fournisseurs.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="fournisseurs" type="dropdown-toggle" class="form-control" name="fournisseur_id" >
                                        <option value="choisir" selected disabled>Choisir Fournisseur</option>
                                        @foreach($fournisseurs as $fournisseur)
                                            <option class="fournisseurs" value="{{$fournisseur->id }}">{{$fournisseur->code_fournisseur}}</option>
                                        @endforeach
                                    </select>
                                </div>                
