        ...
        <div class="card-body">
            ...
            <div >
                <h5 class="card-title"><i class="fa fa-fw fa-search"></i> Chercher Avenant</h5>
                    ...
                    <form class="form-material" type="get" action="{{ route('avenants.search') }}" >
                            <div class="row" >
                                <div class="col-6">
                                    <div class="form-group" style="margin-right: 15px;" >
                                        <input class="form-control " name="codeavenant"  type="search" placeholder="Code d'avenant" >
                                    </div>
                                </div>
                                <div class="col-6 ">
...
<div class="form-material">
        ...
        <div  style="margin-left:50%"> 
            <a class="btn btn-primary " href="{{ route('avenants.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouveau avenant</a> 
        ...
        <h5 style="margin-left: 30px; margin-bottom: 15px;" >Gestion des avenants</h5>
                ...
                <div class="form-group form-primary form-static-label">
                    <select class="form-control" id="avenants" type="dropdown-toggle" class="form-control" name="avenants" onchange="top.location.href = this.options[this.selectedIndex].value" >
                        ...
                        @foreach($avenants as $avenant)
                            <option class="avenants" value="{{  route('avenants.show',$avenant->id) }}">{{$avenant->code_avenant}}</option>
                        @endforeach
                    </select>
                </div>                
