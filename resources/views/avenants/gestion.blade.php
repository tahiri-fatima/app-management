    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des avenants</h5>

                        <form class="form-material" type="get" action="{{ route('avenants.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="avenants" type="dropdown-toggle" class="form-control" name="avenant_id" >
                                        <option value="choisir" selected disabled>Choisir Avenant</option>
                                        @foreach($avenants as $avenant)
                                            <option class="avenants" value="{{$avenant->id }}">{{$avenant->code_avenant}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cet avenant ?</p>
                                </strong>
                            </div>
