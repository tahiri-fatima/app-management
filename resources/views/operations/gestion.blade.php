		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des opérationx</h5>
                        ...
                        <form class="form-material" type="get" action="{{ route('operations.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="operations" type="dropdown-toggle" class="form-control" name="operation_id" >
                                        <option value="choisir" selected disabled>Choisir Opération</option>
                                        @foreach($operations as $operation)
                                            <option class="operations" value="{{$operation->id }}">{{$operation->designation_operation}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer cette opération ?</p>
                                </strong>
                            </div>
