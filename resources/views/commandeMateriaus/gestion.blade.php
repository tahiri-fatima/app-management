    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des matériaux des commandes</h5>

                        <form class="form-material" type="get" action="{{ route('commandeMateriaus.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="commandes" type="dropdown-toggle" class="form-control" name="commande_id" >
                                        <option value="choisir" selected disabled>Choisir Commande</option>
                                        @foreach($commandes as $commande)
                                            <option class="commandes" value="{{$commande->id }}">{{$commande->code_commande}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer les matériaux de la commande ?</p>
                                </strong>
                            </div>
