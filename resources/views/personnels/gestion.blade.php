    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des personnels</h5>

                        <form class="form-material" type="get" action="{{ route('personnels.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="personnels" type="dropdown-toggle" class="form-control" name="personnel_id" >
                                        <option value="choisir" selected disabled>Choisir Personnel</option>
                                        @foreach($personnels as $personnel)
                                            <option class="personnels" value="{{$personnel->id }}">{{$personnel->code_personne}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer ce personnel ?</p>
                                </strong>
                            </div>
