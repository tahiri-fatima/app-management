...
<div class="container" >
		<div class="card">
			<div class="card-body">
				...
				<div >
					<h5 class="card-title"><i class="fa fa-fw fa-search"></i> Chercher nature de frais</h5>

                        <form class="form-material" type="get" action="{{ route('natureFrais.search') }}" >
                                <div class="row" >
                                    <div class="col-6">
                                        <div class="form-group" style="margin-right: 15px;" >
                                            <input class="form-control mr-ms-2" name="code_nature_frais"  type="search" placeholder="Code nature de frais" >
                                        </div>
                                     </div>
                                    <div class="col-6">
       ...
       <div class="form-material">
        ...
        <div style="margin-left: 40%;"> 
            <a class="btn btn-primary text-right" href="{{ route('natureFrais.create') }}"><i class="fa fa-fw fa-plus-circle"></i> Ajouter nouvelle nature du frais</a> 
        ...
        <h5 style="margin-left: 30px; margin-bottom: 15px;" >Gestion des nature des frais</h5>    
                ...
                <div class="form-group form-primary form-static-label">
                    <select class="form-control" id="frais" type="dropdown-toggle" class="form-control" name="nature_frais" onchange="top.location.href = this.options[this.selectedIndex].value" >
                        ...
                        @foreach($natureFrais as $natureFrai)
                            <option class="frais" value="{{  route('natureFrais.show',$natureFrai->id) }}">{{$natureFrai->code_nature_frais}}</option>
                        @endforeach
                    </select>
                </div>                
