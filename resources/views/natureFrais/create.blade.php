...
<!-- Affichage de modal si l'entretien ajouté avec succes. !-->
    @if(!empty(Session::get('success')) && Session::get('success') == 'nature de frais ajouté avec succes.')
    <script>
        $(function() {
            $('#myModal').modal('show');
        });
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-outline-secondary" href="{{ route('natureFrais.index') }}"> Non</a>
...
<div class="col d-flex justify-content-center" > 
    <div class="card" style="width:70%">  
        <div class="card-header">
            <h5><i class="fa fa-fw fa-plus-circle"></i>  Ajouter nouveau nature du frais</h5>
        </div>
        ...
        <p class="row " style="font-weight:bold; margin-bottom : 30px;margin-left : 200px;">Les champs avec <span class="text-danger"> * </span> sont obligatoire.</p>
            ...
            <form class="form-material" id="form" action="{{ route('natureFrais.store') }}" method="POST">
            @csrf
            <div class="row justify-content-center" >
                <div class="col-6">
                    <div class="form-group form-primary form-static-label">
                        <input type="text" name="code_nature_frais" class="form-control" placeholder="Entrer le code du nature">
                        <span class="form-bar"></span>
                        <label class="float-label">Code de nature de frais <span class="text-danger">*</span> </label>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group form-primary form-static-label">
                        <input type="text" name="nature_frais" class="form-control" placeholder="Entrer la nature du frais">
                        <span class="form-bar"></span>
                        <label class="float-label">Intitulé <span class="text-danger">*</span> </label>  
                    </div>
                </div>
