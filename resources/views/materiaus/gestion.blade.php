    ...
    <div class="col d-flex justify-content-center " > 
		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des matériaux</h5>

                        <form class="form-material" type="get" action="{{ route('materiaus.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="materiaus" type="dropdown-toggle" class="form-control" name="materiau_id" >
                                        <option value="choisir" selected disabled>Choisir Matériau</option>
                                        @foreach($materiaus as $materiau)
                                            <option class="materiaus" value="{{$materiau->id }}">{{$materiau->intitule_materiau}}</option>
                                        @endforeach
                                    </select>
                                </div>                
                        ...
                        <div class="modal-content"  >
                            ...
                            <div class="modal-body ">
                                <strong >
                                    ...
                                    <p>Voulez vous supprimer ce matériau ?</p>
                                </strong>
                            </div>
