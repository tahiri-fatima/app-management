		...
		<div class="card">
			<div class="card-body">
					...
					<h5 class="card-title"> Gestion des factures</h5>
                        ...
                        <form class="form-material" type="get" action="{{ route('factures.gotoIndex') }}" >
                       
                        <div class="row " style="margin-left: 30px;" >
                            <div class="col-6">
                                <div class="form-group form-primary form-static-label">
                                    <select class="form-control" id="factures" type="dropdown-toggle" class="form-control" name="facture_id" >
                                        <option value="choisir" selected disabled>Choisir Facture</option>
                                        @foreach($factures as $facture)
                                            <option class="factures" value="{{$facture->id }}">{{$facture->code_facture}}</option>
                                        @endforeach
                                    </select>
                                </div>                
